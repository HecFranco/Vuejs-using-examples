...
-- Tiempo de generación: 07-08-2018 a las 15:16:24
...
ALTER TABLE `list_products_subcategory`
  ADD CONSTRAINT `products_categories` FOREIGN KEY (`products_categories_id`) REFERENCES `list_products_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `products`
  ADD CONSTRAINT `products_subcategory` FOREIGN KEY (`products_subcategory_id`) REFERENCES `list_products_subcategory` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `provider` FOREIGN KEY (`provider_id`) REFERENCES `providers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `translations`
  ADD CONSTRAINT `FK_BC523F9C8C23CB3` FOREIGN KEY (`list_language_id`) REFERENCES `list_languages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_BC523F9CD2EF08F6` FOREIGN KEY (`list_content_id`) REFERENCES `list_contents` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `FK_1483A5E9C7470A42` FOREIGN KEY (`gender`) REFERENCES `list_genders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `users_roles`
--
ALTER TABLE `users_roles`
  ADD CONSTRAINT `FK_51498A8EA76ED395` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_51498A8ED60322AC` FOREIGN KEY (`role_id`) REFERENCES `list_roles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
